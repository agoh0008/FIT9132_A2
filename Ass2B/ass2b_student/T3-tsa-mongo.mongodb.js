...
db.tsa.find({"$and":[{"avg_temperature.summer":{"$gt":25}},
{"resorts.company_name":"Tropical Dream"}]},
{"_id":1, "name":1, "location":1, "avg_temperature":1, "no_of_resorts":1});
...
db.tsa.find({ "resorts.company_name": "Tropical Heaven" });
...
db.tsa.updateOne({"_id":7},
{"$push":{"resorts":{"id":"11","name":"Amazing Resort",
          "address":"12 Duchess Road","phone": "0436708976","year_built":"2018","company_name":"Australia Experience"}}});
