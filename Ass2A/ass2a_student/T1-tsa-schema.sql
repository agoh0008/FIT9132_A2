...
ALTER TABLE cabin
    ADD CONSTRAINT chk_cabin_nobedrooms CHECK ( cabin_nobedrooms IN ( 1, 2, 3, 4 ) );

ALTER TABLE cabin
    ADD CONSTRAINT chk_cabin_bathroom_type CHECK ( cabin_bathroom_type IN ( 'I', 'C' )
    );
